...
class Blockchain(object):
    ...
    def hash(block):
        ...
        # dictionary should be ordered for consistent hashes
    ...
    def proof_of_work(self, last_proof):
        ...
        Simple PoW algorithm
            - Find number p' such that hash(pp') contains 4 leading 0s where p is previous p'
    ...
    def valid_proof(last_proof, proof):
        """
        Validates the proof: Does hash(p, p') contain 4 leading zeroes?
    ...
    def resolve_conflicts(self):
        ...
        # replace chain if new, valid & longer chain discovered
        if new_chain:
...
def mine():
    ...
    # sender '0' signifies that this node has mined a new code
...
def consensus():
    ...
    if replaced:
        ...
        response = {
            'message': 'Chain remains authoritative',
            'chain': blockchain.chain
        }
